...
public class Chessboard {
	...
	public static final char[] WHITE_BACK_RANK = { WHITE_ROOK, WHITE_KNIGHT, WHITE_BISHOP, WHITE_QUEEN, WHITE_KING,
			WHITE_BISHOP, WHITE_KNIGHT, WHITE_ROOK, };

	public static final char[] BLACK_BACK_RANK = { BLACK_ROOK, BLACK_KNIGHT, BLACK_BISHOP, BLACK_QUEEN, BLACK_KING,
